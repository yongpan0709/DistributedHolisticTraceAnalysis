...
MEGATRON_PIPELINE_TEST_DATASETS: Dict[str, Dict] = {
    "1f1b": {
        ...
        "vpp_size": None,
        "micro_batchsize": 32,
        "description": "Megatron pipeline trace with 1f1b schedule (TP=1, PP=4, DP=16, EP=8)",
    },
    "1f1b-interleaved": {
        ...
        "vpp_size": 2,
        "micro_batchsize": 32,
        "description": "Megatron pipeline trace with 1f1b-interleaved schedule (TP=1, PP=4, DP=16, EP=8, VPP=2)",
    },
    # Future datasets will be added here:
